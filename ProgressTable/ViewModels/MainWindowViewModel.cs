...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Кабанов Лалыч Палыч", Visual=1, Architecture=1, Networks=1, Calculate_Math=1, PI=1, Math=1, Electric=1},
                new Student{Name="Узбеков Георгей Замшевич", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Косулин Корбид Чачонов", Visual=0, Architecture=2, Networks=0, Calculate_Math=1, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
